...
- [ ] 在 LayaAir IDE 完成 200 人三职业混编局部避让验收：两队各 100 人（战士 40、法师 30、牧师 30），密集编队能稳定横移绕行，绕行后按 `Skill.CastRange + target.range` 进入攻击、停止 Run 并释放技能；死亡、回池和重复进入后无位置抖动、卡死或残留绕行方向。
