...
public class LoginRequest {
    ...
    public static class LoginRequestBuilder {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public LoginRequest.LoginRequestBuilder type(final ThirdPartyAuthService.ThirdPartyType type) {
            this.type = type;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
        public LoginRequest.LoginRequestBuilder authCode(final String authCode) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public LoginRequest.LoginRequestBuilder clientIp(final String clientIp) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public LoginRequest.LoginRequestBuilder deviceInfo(final String deviceInfo) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public LoginRequest.LoginRequestBuilder platform(final String platform) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public LoginRequest.LoginRequestBuilder version(final String version) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public LoginRequest.LoginRequestBuilder extraParams(final String extraParams) {
        ...
        public LoginRequest build() {
            return new LoginRequest(this.type, this.authCode, this.clientIp, this.deviceInfo, this.platform, this.version, this.extraParams);
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
        public java.lang.String toString() {
            return "LoginRequest.LoginRequestBuilder(type=" + this.type + ", authCode=" + this.authCode + ", clientIp=" + this.clientIp + ", deviceInfo=" + this.deviceInfo + ", platform=" + this.platform + ", version=" + this.version + ", extraParams=" + this.extraParams + ")";
        }
    }
    ...
    @java.lang.SuppressWarnings("all")
    public java.lang.String toString() {
        return "LoginRequest(type=" + this.getType() + ", authCode=" + this.getAuthCode() + ", clientIp=" + this.getClientIp() + ", deviceInfo=" + this.getDeviceInfo() + ", platform=" + this.getPlatform() + ", version=" + this.getVersion() + ", extraParams=" + this.getExtraParams() + ")";
    }
    ...
    @java.lang.SuppressWarnings("all")
    public LoginRequest(final ThirdPartyAuthService.ThirdPartyType type, final String authCode, final String clientIp, final String deviceInfo, final String platform, final String version, final String extraParams) {
        this.type = type;
        this.authCode = authCode;
        this.clientIp = clientIp;
        this.deviceInfo = deviceInfo;
